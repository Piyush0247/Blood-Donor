...
fun SignUpActivity(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Box{
            Image(
                painterResource(R.drawable.sign_in), contentDescription = "image",
            ...
            Column(modifier = Modifier.fillMaxSize().padding(18.dp),
                ...
                OutlinedTextField(
                    ...
                    placeholder = { Text("Enter the confirm Password") },
                    shape = RoundedCornerShape(10.dp),
                    keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Password)
                )
                Spacer(modifier = Modifier.height(10.dp))
                        ...
                        auth.createUserWithEmailAndPassword(email,password)
                            .addOnCompleteListener { task ->
                                if (task.isSuccessful){
                                    ...
                                    Toast.makeText(context,"Signup Failed try after some time",
                ...
                TextButton(onClick = {navController.navigate(Screen.LoginActivity.route)}) {
                    Text("Already have an account?", fontSize = 18.sp, color = Color.White)
                }
            }
        }
